...
function fetchData() {
    setTimeout(() => {
        chatgptResponse = {
            ...
            "data": [
                {
                    "url": "https://oaidalleapiprodscus.blob.core.windows.net/private/org-Wbs0Yd6PTO0gGxxxosymOYg3/user-40gFIgohCrueES59vdE3EmgA/img-rhx2pQSdrmastADiSPwIk2Pq.png?st=2023-10-25T09%3A05%3A53Z&se=2023-10-25T11%3A05%3A53Z&sp=r&sv=2021-08-06&sr=b&rscd=inline&rsct=image/png&skoid=6aaadede-4fb3-4698-a8f6-684d7786b067&sktid=a48cca56-e6da-484e-a814-9c849652bcb3&skt=2023-10-25T01%3A01%3A36Z&ske=2023-10-26T01%3A01%3A36Z&sks=b&skv=2021-08-06&sig=A0jH3l/6VJJMCsWuXGzuUUtt0aaEB0vx%2BP/gsHmkejs%3D"
                },
                {
                    "url": "https://oaidalleapiprodscus.blob.core.windows.net/private/org-Wbs0Yd6PTO0gGxxxosymOYg3/user-40gFIgohCrueES59vdE3EmgA/img-zUl8j8jb13n3RuE28dQOKtW9.png?st=2023-10-25T09%3A05%3A53Z&se=2023-10-25T11%3A05%3A53Z&sp=r&sv=2021-08-06&sr=b&rscd=inline&rsct=image/png&skoid=6aaadede-4fb3-4698-a8f6-684d7786b067&sktid=a48cca56-e6da-484e-a814-9c849652bcb3&skt=2023-10-25T01%3A01%3A36Z&ske=2023-10-26T01%3A01%3A36Z&sks=b&skv=2021-08-06&sig=Vc4FMglnUeRJUNQjntJ/vgubP3Y0S0LtTe/PhOSrui0%3D"
                },
                {
                    "url": "https://oaidalleapiprodscus.blob.core.windows.net/private/org-Wbs0Yd6PTO0gGxxxosymOYg3/user-40gFIgohCrueES59vdE3EmgA/img-rhx2pQSdrmastADiSPwIk2Pq.png?st=2023-10-25T09%3A05%3A53Z&se=2023-10-25T11%3A05%3A53Z&sp=r&sv=2021-08-06&sr=b&rscd=inline&rsct=image/png&skoid=6aaadede-4fb3-4698-a8f6-684d7786b067&sktid=a48cca56-e6da-484e-a814-9c849652bcb3&skt=2023-10-25T01%3A01%3A36Z&ske=2023-10-26T01%3A01%3A36Z&sks=b&skv=2021-08-06&sig=A0jH3l/6VJJMCsWuXGzuUUtt0aaEB0vx%2BP/gsHmkejs%3D"
                },
        ...
        chatgptResponse.data.forEach(d => imageUrls.push(d.url))
...
function gptComment() {
    ...
    document.querySelectorAll('.gpt-comment')[document.querySelectorAll('.gpt-comment').length - 1].insertAdjacentHTML('beforeend', `
    <div class="bg-white rounded-lg shadow-md p-1 space-y-4 max-w-[30rem] max-h-[30rem]">
        <div class="flex flex-col space-y-1">
            <div class="flex space-x-1">
                <a href="${imageUrls[0]}" target="_blank" class="w-[calc(50%-2px)]"><img src="${imageUrls[0]}" class="rounded-md"></a>
                <a href="${imageUrls[1]}" target="_blank" class="w-[calc(50%-2px)]"><img src="${imageUrls[1]}" class="rounded-md"></a>
            </div>
            <div class="flex space-x-1">
                <a href="${imageUrls[2]}" target="_blank" class="w-[calc(50%-2px)]"><img src="${imageUrls[2]}" class="rounded-md"></a>
                <a href="${imageUrls[3]}" target="_blank" class="w-[calc(50%-2px)]"><img src="${imageUrls[3]}" class="rounded-md"></a>
            </div>
        </div>
    </div>
    `)
